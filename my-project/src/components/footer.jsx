    ...
    <>
      <div className="md:px-20 px-3">
        <div className="text-center bg-darkBlue relative md:h-96 flex items-center flex-col rounded-xl justify-center">
          ...
          <h1 className="text-white z-40 md:text-5xl text-2xl font-sans font-normal md:w-2/3 leading-tight pt-5 md:pt-0 md:leading-snug mb-10">An enterprise template to ramp up your company website</h1>
          <span className="flex pb-6 px-3 md:gap-4 gap-2">
            <input type="text" className="md:w-96 md:px-6 w-40 text-blaack placeholder:text-black md:text-xl px-3 rounded-xl h-10 md:h-full font-normal md:py-3 md:rounded-full" placeholder="Your email address" />
            <button className="bg-green md:px-6 text-darkBlue font-bold md:text-xl rounded-xl px-3 md:rounded-full">Start now</button>
          </span>
        </div>

        <div className="flex md:flex-row flex-col-reverse gap-5 md:gap-20 md:pb-20 mt-10 pb-10 md:mt-20 md:items-center font-sans">
          ...
          <div className="md:w-2/4 w-full flex flex-col gap-y-2 md:gap-y-6">
          ...
          <div className="w-2/4 flex flex-col gap-y-2 md:gap-y-6">
